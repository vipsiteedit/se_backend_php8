<?php
function module_shopsearch($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/shopsearch';
 else $__MDL_URL = 'modules/shopsearch';
 $__MDL_ROOT = dirname(__FILE__).'/shopsearch';
 ...
 if (isRequest('ajax'.$razdel)) {
     ...
     $options = array(
         ...
         'textprice'=>trim($section->parametrs->param23)
     );
