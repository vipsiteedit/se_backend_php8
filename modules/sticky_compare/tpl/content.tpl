...
<div class="content sticky_compare<?php if(strval($section->parametrs->param13)=='n'): ?> container<?php else: ?> container-fluid<?php endif; ?>" data-content-type="<?php echo $section->type ?>" data-content-id="<?php echo $section->id ?>" >
