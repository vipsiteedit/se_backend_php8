...
$main_fields = array(
    ...
    'delivin' => $section->parametrs->param14 == 'Y' ? $section->language->lang040 : ''
);
...
<span class="marks">(<a class="marksLabel" href="' . $line['link'] . '#reviews">' . $section->language->lang036 . '</a> <span class="marksValue">' . $line['marks'] . '</span>)</span></div>';
            ...
            case 'price':{
                ...
                } else $main_compares[$key]['values'][$line['id']] = 'по запросу';
                break;
                }
            case 'count':
            ...
            case 'delivin': { 
                if (!empty($line['delivery_time']))
                    $main_compares[$key]['values'][$line['id']] = $line['delivery_time'];
                else 
                    $main_compares[$key]['values'][$line['id']] = $section->language->lang038;
               break;
            }
        }
