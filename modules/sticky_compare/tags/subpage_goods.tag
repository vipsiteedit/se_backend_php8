  ...
  <div class="sticky_compare-control_item__remove_all">
   ...
   <div class="sticky_compare-compare_items__header"> 
    <repeat:product name=pr>
     <div class="sticky_compare-item_header" data-item-id="[pr.id]" data-shop-item="">
      <div class="sticky_compare-item_description">
       ...
       <div class="sticky_compare-item_title">
        <a class="sticky_compare-item_title_text" href="[pr.link]" title="[pr.name]" data-shop-item-title="">[pr.name]</a> 
        <span data-shop-item-article="" style="display: none;">[pr.article]</span>
       </div>
      </div>
      <if:([pr.price]>0)>
      ...
      <else>
        ...
        <a class="sticky_compare-item__button_remove" title="[lang023]" data-remove-id="[pr.id]" href="<serv>?del_compare=[pr.id]</serv><se>#</se>">
        [lang024]</a>
      </if>
     </div>
    </repeat:product>
