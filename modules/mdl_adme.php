<?php
function module_adme($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/adme';
 else $__MDL_URL = 'modules/adme';
 $__MDL_ROOT = dirname(__FILE__).'/adme';
 ...
 if ($specdesign == 'enable') {
    if (file_exists(SE_ROOT . SE_DIR .'skin/'.delExtFile($section->parametrs->param1).'.map')) {
