<?php
function module_shopflycart($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/shopflycart';
 else $__MDL_URL = 'modules/shopflycart';
 $__MDL_ROOT = dirname(__FILE__).'/shopflycart';
