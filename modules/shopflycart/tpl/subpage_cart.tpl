    ...
    <div id="headCart">
        <a id="linkGoCart" href="<?php echo $__data->getPagePattern($section->parametrs->param4) ?>"><?php echo $section->language->lang022 ?></a>
...
<?php endforeach; ?>            
    ...
    <div id="footCart">
        <a href="<?php echo $__data->getPagePattern($section->parametrs->param4) ?>" class="orderLink" title="<?php echo $section->language->lang017 ?>"><?php echo $section->language->lang028 ?></a>
        <a href="<?php echo $__data->getPagePattern($section->parametrs->param4) ?>cart_clear/" class="clearCartLink" title="<?php echo $section->language->lang030 ?>" style="display:none;"><?php echo $section->language->lang029 ?></a>
    </div>
