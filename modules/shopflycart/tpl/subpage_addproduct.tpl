<div class="">
    ...
    <div class="">
        ...
        <a href="<?php echo $__data->getPagePattern($section->parametrs->param4) ?>" class="btn btn-link"><?php echo $section->language->lang037 ?></a>
    </div>
    ...
    <div class="panel-footer">
        ...
        <a href="<?php echo $__data->getPagePattern($section->parametrs->param4) ?>#blockCartContact" class="btn btn-default pull-right" title="<?php echo $section->language->lang017 ?>"><?php echo $section->language->lang028 ?></a>
    </div>  
