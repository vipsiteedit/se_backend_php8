<?php
function module_shopvitrine($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/shopvitrine';
 else $__MDL_URL = 'modules/shopvitrine';
 $__MDL_ROOT = dirname(__FILE__).'/shopvitrine';
