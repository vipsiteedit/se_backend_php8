<?php
function module_shopcatalog_picture($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/shopcatalog_picture';
 else $__MDL_URL = 'modules/shopcatalog_picture';
 $__MDL_ROOT = dirname(__FILE__).'/shopcatalog_picture';
 ...
 if (!empty($tree)) {
     $select_group = $plugin_groups->checkUrl(trim($section->parametrs->param5));
     /*
     if (isRequest('cat'))
