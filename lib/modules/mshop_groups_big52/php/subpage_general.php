...
$__data->page->keywords = htmlspecialchars((string)$shop_variables->parseGroupText($group['keywords'], $group));
...
if (!empty($description))
    ...
    $__data->page->description = htmlspecialchars((string)$thisgroup_commentary);
